...
/**
 * HTML Article View class for the Faqs component
 *
 * @package		BuBujie.Dev
 * @subpackage	com_faqs
 * @since		1.5
...
class FaqsViewForm extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if (empty($this->item->id)) {
			...
			$authorised = $user->authorise('core.edit', 'com_faqs.faq.'.$this->item->id);
		}
	...
	protected function _prepareDocument()
	{
		...
		if (empty($this->item->id)) {
		$head = JText::_('COM_FAQS_FORM_SUBMIT_FAQ');
		}
		else {
		$head = JText::_('COM_FAQS_FORM_EDIT_FAQ');
		}
