...
class dropMenuLinks
{
  public static function gets($id_lang, $id_link = null)
  {
    ...
    FROM '._DB_PREFIX_.'linksdropmenu l 
    LEFT JOIN '._DB_PREFIX_.'linksdropmenu_lang ll ON (l.id_link = ll.id_link AND ll.id_lang = "'.$id_lang.'") 
  ...
  public static function add($link, $label, $newWindow = 0)
  {
    ...
    {
      Db::getInstance()->autoExecute(
        _DB_PREFIX_.'linksdropmenu_lang',
        array(
          'id_link'=>$id_link,
          'id_lang'=>$id_lang,
          'label'=>$label
  ...
  {
    Db::getInstance()->delete(_DB_PREFIX_.'linksdropmenu', "id_link = '{$id_link}'"); 
    Db::getInstance()->delete(_DB_PREFIX_.'linksdropmenu_lang', "id_link = '{$id_link}'");
  }
}
?>