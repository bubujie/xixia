			...
			if ($row->prev || $row->next) {
				...
				if ($row->prev) {
					...
					<li class="pagenav-prev">
						<a href="'. $row->prev .'" rel="prev" class="btnDate"><span>'
							. JText::_('JGLOBAL_LT') . $pnSpace . JText::_('JPREV') . '</span></a>
					</li>'
					;
				}
				...
				if ($row->next) {
					...
					<li class="pagenav-next">
						<a href="'. $row->next .'" rel="next" class="btnDate"><span>'
							. JText::_('JNEXT') . $pnSpace . JText::_('JGLOBAL_GT') .'</span></a>
					</li>'
					;
				}
				$html .= '
