...
public function hookDisplayBheadTop($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayBheadBtm($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayBbodyTop($params)    { return $this->hookLeftColumn($params); }
public function hookDisplaySide1Top($params)    { return $this->hookLeftColumn($params); }
public function hookDisplaySide1Btm($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayMainTop($params)     { return $this->hookLeftColumn($params); }
public function hookDisplayContentSide1($params){ return $this->hookLeftColumn($params); }
public function hookDisplayContentTop($params)  { return $this->hookLeftColumn($params); }
public function hookDisplayContentBtm($params)  { return $this->hookLeftColumn($params); }
public function hookDisplayContentSide2($params){ return $this->hookLeftColumn($params); }
public function hookDisplayMainBtm($params)     { return $this->hookLeftColumn($params); }
public function hookDisplaySide2Top($params)    { return $this->hookLeftColumn($params); }
public function hookDisplaySide2Btm($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayBbodyBtm($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayBfootTop($params)    { return $this->hookLeftColumn($params); }
public function hookDisplayBfootBtm($params)    { return $this->hookLeftColumn($params); }
