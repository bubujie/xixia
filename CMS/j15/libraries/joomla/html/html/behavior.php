...
class JHTMLBehavior
{
	...
	function mootools($debug = null)
	{
		...
		if ($debug || $konkcheck) {// JHTML::script('mootools.js', 'http://ajax.googleapis.com/ajax/libs/mootools/1.1.2/', false);
			JHTML::script('mootools-uncompressed.js', 'media/system/js/', false);
		} else {// JHTML::script('mootools-yui-compressed.js', 'http://ajax.googleapis.com/ajax/libs/mootools/1.1.2/', false);
