...
//$_additionalUrlParams = array();
	 ...
	 * @since   11.1
	 */
	function setAdditionalUrlParam($key, $value)
	{
	 ...
	 * @since   11.1
	 */
	function getAdditionalUrlParam($key)
	{
		$result = isset($this->_additionalUrlParams[$key]) ? $this->_additionalUrlParams[$key] : null;
	 ...
	 * @since   11.1
	 */
	function orderUpIcon($i, $condition = true, $task = 'orderup', $alt = 'JLIB_HTML_MOVE_UP', $enabled = true, $checkbox = 'cb')
	{
	 ...
	 * @since   11.1
	 */
	function orderDownIcon($i, $n, $condition = true, $task = 'orderdown', $alt = 'JLIB_HTML_MOVE_DOWN', $enabled = true, $checkbox = 'cb')
	{
