...
<div class="addresses" id="featured-products_block_center">
	...
	{foreach from=$products item=product name=i}
		...
		<div class="ajax_block_product">
			...
			{/if}
				<br />{l s='Quantity:' mod='blockwishlist'}<input type="text" id="{$product.id_product}_{$product.id_product_attribute}" size="3" value="{$product.quantity|intval}" readonly="readonly" />
