...
class FrontControllerCore extends Controller
{
	...
	public function setMedia()
	{
		...
		$this->addCSS(_THEME_CSS_DIR_.'suio.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_1.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_2.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_3.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_4.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_5.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_6.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listmain_7.css', 'all');
		$this->addCSS(_THEME_CSS_DIR_.'product/listnormal.css', 'all');
		$this->addjquery();
