 ...
 * @since		1.5
 */
class FaqsControllerFaq extends JControllerForm
{
	/**
	 * @since	1.6
	 */
	...
	protected function postSaveHook(JModel &$model, $validData = array())
	{
		...
		if ($task == 'save') {
			$this->setRedirect(JRoute::_('index.php?option=com_faqs&view=category&id='.$validData['catid'], false));
		}
	}
	...
	public function go()
	{
		...
		$modelLink	= $this->getModel('Faq', '', array('ignore_request' => true));
		...
		if (empty($link)) {
			return JError::raiseWarning(404, JText::_('COM_FAQS_ERROR_FAQ_NOT_FOUND'));
		}
		...
		$modelCat = $this->getModel('Category', 'FaqsModel', array('ignore_request' => true));
		...
		if ($link->url) {
			...
			return JError::raiseWarning(404, JText::_('COM_FAQS_ERROR_FAQ_URL_INVALID'));
		}
	}
}
