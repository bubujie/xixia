<?php
/**
 * @copyright	Copyright (C) 2008 - 2014 步步街工作室, Inc. All rights reserved.
		...
		if ($params->get('show_item_navigation') && ($context == 'com_content.article') && ($view == 'article')) {
	       ...
	       //sqlsrv changes
	        ...
	        $case_when1 .= $c_id.' END as catslug';
      		$query->select('a.id, a.title, a.created, a.language,'.$case_when.','.$case_when1);
