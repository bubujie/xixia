...
// check modules
$showRightColumn	= ($this->countModules('side2-btm') or $this->countModules('side2-top') or $this->countModules('side2'));
$showbottom			= ($this->countModules('bfoot') or $this->countModules('bfoot') or $this->countModules('bfoot'));
$showleft			= ($this->countModules('side1') or $this->countModules('side1-top') or $this->countModules('side1-btm'));
...
<div id="all">
	...
	<?php if(!$templateparams->get('html5', 0)): ?>
		...
		<header id="header">
			<?php endif; ?>
				<div class="logoheader">
					...
					<jdoc:include type="modules" name="bhead" />
					<div id="line">
					<div id="fontsize"></div>
		...
		<div id="header-image">
			<jdoc:include type="modules" name="bhead5" />
			<?php if ($this->countModules('bhead5')==0): ?>
		...
		<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					<?php if ($navposition=='left' and $showleft) : ?>
						...
						<?php endif; ?>
								...
								<jdoc:include type="modules" name="side1-top" style="beezDivision" headerLevel="3" />
								<jdoc:include type="modules" name="side1" style="beezHide" headerLevel="3" state="0 " />
								<jdoc:include type="modules" name="side1-btm" style="beezTabs" headerLevel="2"  id="3" />
					...
					<div id="<?php echo $showRightColumn ? 'wrapper' : 'wrapper2'; ?>" <?php if (isset($showno)){echo 'class="shownocolumns"';}?>>
						...
						<?php if ($this->countModules('bhead2')): ?>
							<div id="top"><jdoc:include type="modules" name="bhead2"   />
							</div>
						<?php endif; ?>
				...
				<?php endif; ?>
						...
						<a id="additional"></a>
						<jdoc:include type="modules" name="side2-top" style="beezDivision" headerLevel="3"/>
						<jdoc:include type="modules" name="side2" style="beezDivision" headerLevel="3"  />
						<jdoc:include type="modules" name="side2-btm" style="beezDivision" headerLevel="3"  />
		...
		<?php if ($showbottom) : ?>
			<div id="footer-inner">
				...
				<div id="bottom">
					<?php if ($this->countModules('bfoot')): ?>
					<div class="box box1"> <jdoc:include type="modules" name="bfoot" style="beezDivision" headerlevel="3" /></div>
					<?php endif; ?>
					   <?php if ($this->countModules('bfoot')): ?>
					<div class="box box2"> <jdoc:include type="modules" name="bfoot" style="beezDivision" headerlevel="3" /></div>
					<?php endif; ?>
					<?php if ($this->countModules('bfoot')): ?>
					<div class="box box3"> <jdoc:include type="modules" name="bfoot" style="beezDivision" headerlevel="3" /></div>
					<?php endif ; ?>
				</div>
			</div>
		<?php endif ; ?>
			...
			<?php endif; ?>
					...
					<jdoc:include type="modules" name="bhead4" />
					<p>
