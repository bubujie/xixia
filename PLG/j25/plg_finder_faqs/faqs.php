...
/**
 * Finder adapter for Joomla Faqs.
 *
 * @package     Joomla.Plugin
 * @subpackage  Finder.Faqs
 * @since       2.5
 */
class plgFinderFaqs extends FinderIndexerAdapter
{
	/**
	...
	{
		// Make sure we're handling com_faqs categories
		if ($extension == 'com_faqs')
		{
	...
	public function onFinderAfterSave($context, $row, $isNew)
	{
		...
		if ($context == 'com_faqs.faq' || $context == 'com_faqs.form' )
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = FaqsHelperRoute::getFaqRoute($item->slug, $item->catslug);
