...
<form action="<?php echo JRoute::_('index.php?option=com_faqs&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="faq-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FAQS_NEW_FAQ') : JText::sprintf('COM_FAQS_EDIT_FAQ', $this->item->id); ?></legend>
